<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $PRMCNT = mysqli_real_escape_string($con,$_POST['PCN']);
        $SCNCNT = mysqli_real_escape_string($con,$_POST['SCN']);

        $pass = password_hash($PW,PASSWORD_BCRYPT);
        $cpass = password_hash($CNFPW,PASSWORD_BCRYPT);

        $emailquery = "SELECT * FROM userreg WHERE email='$E' ";
        ...
        if($emailcount>0){
            ...
            if($PW === $CNFPW){
                $sql = "INSERT INTO userreg(ID, name , email, rdbgender, phone, address, password, cnfpassword, PCN, SCN, dt) VALUES ('$id','$N','$E','$G','$PH','$ADD','$pass','$cpass','$PRMCNT','$SCNCNT',current_timestamp())";
...
<body>
    <div class="header" id="header">
        ...
        <div class="signupformuser">
        <form class="signupuser" action="userreg.php" method="POST">
                ...
                <label for="phone"><b>Mobile</b><br>
                    <input class="tel" type="tel" placeholder="&nbsp;Mobile Number" name="phone" pattern="[0-9]{4}[0-9]{2}[0-9]{4}" required></label><br><br>

                    <label for="address">Address</label>
                    <input class="address" name="address" type="text" placeholder="Enter  Your Address" required><br><br>
                    
                    <label for="psw"><b>Create Password</b></label>
                    <input class="password" type="password" placeholder="&nbsp;&nbsp;Create Your Password" name="password" required><br><br>
                    
                    <label for="psw"><b>Confirm-Password</b></label>
                    <input class="password" type="password" placeholder="&nbsp;&nbsp;Confirm Your Password" name="cnfpassword" required><br><br><br><br><br>
                    
                    <h4 style="color: rgb(189, 222, 252);">For Emergency</h4><br>
                    <label for="phone"><b>Primary Contact</b><br>
                    <input class="tel" type="tel" placeholder="&nbsp;Mobile Number" name="PCN" pattern="[0-9]{4}[0-9]{2}[0-9]{4}" required></label><br><br>
                                        
                    <label for="phone"><b>Secondary Contact</b><br>
                    <input class="tel" type="tel" placeholder="&nbsp;Mobile Number" name="SCN" pattern="[0-9]{4}[0-9]{2}[0-9]{4}" required></label><br><br>
                    ...
                    <button type="submit" class="regbtnuser" name='submit' onclick="validcap()">Register</button><br><br>
                  <input type="checkbox" checked="checked" name="remember"> Remember me<br><br>
                <label for="signup"><i>Already a member?<a href="http://localhost/interface/userlogin.php" class="signinlink">&nbsp;SignIn</a></i></label>
            </form>
        </div><br><br><br>
