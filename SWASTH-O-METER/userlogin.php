...
<body>
    ...
    <script type="text/javascript">
        ...
        <div class="user"><h2>USER</h2></div><br>
        <div class="loginform">
    <form class="login" action="userlogin.php" method="POST">
            ...
            <label for="signup"><i>Not a member?<a href="http://localhost/interface/userreg.php" class="signuplink">&nbsp;SignUp/Register</a></i></label>
        </form>
    </div><br><br><br>
